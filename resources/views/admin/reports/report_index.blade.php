                ...
                <div class="card-header py-3">
                    ...
                    <form class="row g-3" method="GET" action="{{ route('admin.reports') }}">
                        <div class="col-4">
                            ...
                            <select type="text" name="bank_code" class="form-control" required id="inputname" placeholder="Bank Name">
                                <option value="">Silahkan Pilih Bank</option>
                                @forelse($banks as $bank)
                                    <option {{ $bank->code == old('bank_code') ? 'selected': ''}} value="{{ $bank->code }}">{{ $bank->name }}</option>
                                @empty
                        ...
                        <div class="col-auto">
                            ...
                            <select type="text" name="unit_code" class="form-control" id="inputname" placeholder="Bank Name">
                    ...
                    <table class="table table-striped" id="report">
                        ...
                        @forelse($transactions as $transaction)
                            <tr>
                                ...
                                <td>{{ !isset($transaction->TSLAservice) ? '00:00:00' : $transaction->TSLAservice }}</td>
